...
import { Form, Input, Button, Col, Row, Upload, message,Avatar ,Table,Space} from "antd";
import {
    UserOutlined,
    LockOutlined,
    MailOutlined,
    ...
    },
    {
        ...
        render: (text, record) => (
            <Space>
                ...
                <Button type="link" onClick={() => console.log('Delete user:', record.id)}>{deletebtn}</Button>
            </Space>
        ),
    },
];
